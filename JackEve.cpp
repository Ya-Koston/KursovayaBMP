...
int main () {
	...
	//очистим память взятую под буффер
//	cout<<"Type: "<<picture.B<<picture.M<<endl<<"Width: "<<picture.biWidth<<endl<<"Height: "<<picture.biHeight<<endl<<bbyte<<sizeof(buffer)<<b;//вывод для проверки
	free(buffer);
